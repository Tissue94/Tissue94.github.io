        ...
        <div className='d-flex'>
          <div className='front-containner'>
            <div className='d-flex'>
              ...
              <img src={react} style={{width:"100px", height:"100px", marginTop:"25px", borderRadius:"20px"}}/>
            </div>
            <div className='d-flex'>
          ...
          <div className='back-containner'>
            ...
            <div className='d-flex'>
               ...
               <img src={mybatis} style={{width:"160px", height:"140px", marnpmginLeft : "20px", marginTop : "10px"}} />
            </div>
          </div>
        </div>
      </div>
